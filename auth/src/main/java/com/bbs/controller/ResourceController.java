...
public class ResourceController {
    ...
    @PostMapping
    public Result<Boolean> addResource(@RequestBody com.bbs.entity.Resource resource) {
    ...
    @GetMapping("/list")
    public Result<Page<com.bbs.entity.Resource>> searchList(SearchListParam param) {
    ...
    public static class UserConfig {
        private com.bbs.entity.Resource clinicName;

        private com.bbs.entity.Resource stockStateCountRule;

        private com.bbs.entity.Resource stockStateCountVal;

        private com.bbs.entity.Resource stockStateCountUnit;

        private com.bbs.entity.Resource expiryAlert;
    }
    ...
    @GetMapping("/page")
    public Result<com.bbs.entity.Resource> searchPage(@Valid @NotNull Long id) {
        return service.searchPage(id);
    }

    @GetMapping("/page/list")
    public Result<List<com.bbs.entity.Resource>> searchPage(String name) {
