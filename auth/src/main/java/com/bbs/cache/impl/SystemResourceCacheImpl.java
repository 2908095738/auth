...
import com.bbs.cache.SystemResourceCache;
...
import static com.bbs.cache.impl.SystemResourceCacheImpl.ResourceCache.isTopLevelResource;
import static com.bbs.cache.impl.SystemResourceCacheImpl.ResourceCache.notTopLevelResource;
import static com.bbs.enums.RedisKeys.*;
import static com.bbs.util.RedisUtil.Redisson.lockExec;
...
public class SystemResourceCacheImpl implements SystemResourceCache {
    ...
    public static class ResourceTreeCacheImpl implements ResourceTreeCache {
        ...
        public Result<Boolean> reload() {
            try {
                return lockExec(redisson.getSpinLock(lockKey), 500, 2000, MILLISECONDS, () -> {
