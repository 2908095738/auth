...
public class SearchUserDisposable {
    ...
    public Result<Boolean> finished(@RequestParam String code) {
        return Result.success(userDisposableService.save(new UserDisposable(userService.loginUser().getId(), code)));
    }
}
