...
import com.bbs.auth.vx.GetAppID;
import com.bbs.auth.vx.GetSecret;
import com.bbs.auth.vx.VXLoginAuthAPI;
...
public class VXProgramRegister {
    ...
    public Result<UserVO> register(@RequestBody Param param) {
        return redissonUtil.lockExec(() -> {
                ...
                redisson.getSpinLock(RedisKeys.USER_PHONE_REGISTER.LOCK.key(param.phone)),
