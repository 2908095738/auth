...
import com.auth.cache.impl.SystemResourceCacheImpl;
import com.auth.controller.ResourceController;
...
import com.auth.mapper.ResourceMapper;
...
import static com.auth.enums.ResourceNames.UserConfig.*;
...
public class ResourceServiceImpl extends MPJBaseServiceImpl<ResourceMapper, Resource>
    ...
    public void saveUserConfig(Long uid, String name, String value, String errorMsg) throws DbRuntimeException {
        if(!save(new com.auth.entity.Resource(
