...
import com.auth.cache.PermissionCache;
...
public class PermissionCacheImpl implements PermissionCache {
    ...
    public static class UserGroupCacheImpl implements UserGroup {
        ...
        @Override
        public List<com.auth.entity.UserGroup> search(Long uid) {
            return null;
        }
    }
    ...
    public static class RoleGroupCacheImpl implements RoleGroup {
        ...
        @Override
        public List<com.auth.entity.RoleGroup> search(List<Long> groupIds) {
            return null;
        }
    }
    ...
    public static class RoleResourceCacheImpl implements RoleResource {
        ...
        @Override
        public List<com.auth.entity.RoleResource> search(List<Long> roleIds) {
            return null;
        }
    }
}
