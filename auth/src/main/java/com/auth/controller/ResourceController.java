...
import com.auth.service.ResourceTypeService;
...
public class ResourceController {
    ...
    @PostMapping
    public Result<Boolean> addResource(@RequestBody com.auth.entity.Resource resource) {
    ...
    public static class BatchAddResourceParam {
        ...
        private List<com.auth.entity.Resource> resources;
    }
    ...
    @GetMapping("/list")
    public Result<Page<com.auth.entity.Resource>> searchList(SearchListParam param) {
    ...
    public static class UserConfig {
        private com.auth.entity.Resource clinicName;

        private com.auth.entity.Resource stockStateCountRule;

        private com.auth.entity.Resource stockStateCountVal;

        private com.auth.entity.Resource stockStateCountUnit;

        private com.auth.entity.Resource expiryAlert;
    }
    ...
    @GetMapping("/page")
    public Result<com.auth.entity.Resource> searchPage(@Valid @NotNull Long id) {
        return service.searchPage(id);
    }

    @GetMapping("/page/list")
    public Result<List<com.auth.entity.Resource>> searchPage(String name) {
