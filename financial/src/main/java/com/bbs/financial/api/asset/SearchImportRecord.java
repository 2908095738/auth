...
public class SearchImportRecord {
    ...
    public Result<List<AssetImportRecord>> search(@RequestParam Long companyId) {
        return Result.success(recordService.lambdaQuery().eq(AssetImportRecord::getCompanyId, companyId).list());
    }
}
